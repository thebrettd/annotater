...
PORT=8080                       # PORT on which your server is listening
...
formatHTML() {
    read input
    echo $input | python -c "import html5lib as h5; import sys; sys.stdout.write(h5.serialize(h5.parse(sys.stdin.read())))"
}
